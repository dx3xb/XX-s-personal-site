...
- For every image you want to show, create a placeholder token in the code: {{image:ID}}
- Also return an "image_prompts" array in the JSON response with the same IDs and a Chinese prompt for each image.
...
- "@mui/material": "^6.4.6"  
    ...
    - All images must use placeholders like {{image:ID}} in code and provide prompts in image_prompts.
